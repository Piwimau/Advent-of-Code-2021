...
internal sealed partial class Program {
    ...
    private readonly partial record struct Player(int Position, int Score) {
        ...
        public static Player Parse(ReadOnlySpan<char> s) {
            ...
            int position = int.Parse(s[(s.LastIndexOf(' ') + 1)..]);
    ...
    private static void Main() {
        ...
        Console.WriteLine($"The score using the deterministic die is {deterministicScore}.");
        Console.WriteLine($"The maximum number of wins is {Math.Max(firstWins, secondWins)}.");
    }
