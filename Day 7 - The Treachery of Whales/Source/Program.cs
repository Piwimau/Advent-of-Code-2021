...
internal sealed class Program {
    ...
    private static void Main() {
        ...
        Console.WriteLine($"Minimum fuel required at a constant burn rate is {minFuelConstant}.");
        Console.WriteLine($"Minimum fuel required at a dynamic burn rate is {minFuelDynamic}.");
    }
