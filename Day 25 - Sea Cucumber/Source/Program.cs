...
internal sealed class Program {
    ...
    private sealed class Seafloor {
        ...
        private Seafloor(Cucumber[][] cucumbers) {
            ArgumentNullException.ThrowIfNull(cucumbers, nameof(cucumbers));
        ...
        public static Seafloor Parse(string s) {
            ...
            Cucumber[][] cucumbers = [.. s.Split(Environment.NewLine)
                .Select(line => line.Select(ParseCucumber).ToArray())
            ];
    ...
    private static void Main() {
        ...
        Console.WriteLine($"The first step in which no cucumbers move is {step + 1}.");
    }
