...
internal sealed partial class Program {
    ...
    private static void Main() {
        ...
        Console.WriteLine($"The largest accepted model number is {largestAcceptedModelNumber}.");
        Console.WriteLine($"The smallest accepted model number is {smallestAcceptedModelNumber}.");
    }
