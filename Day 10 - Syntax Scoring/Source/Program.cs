...
internal sealed class Program {
    ...
    /// First incorrect closing brace found if the line is corrupted, otherwise '\0'.
    /// </param>
    /// <returns>
    ...
    /// </returns>
    private static (long SyntaxErrorScore, long MedianAutocompleteScore) SyntaxScoring(
    ...
    private static void Main() {
        ...
        (long syntaxErrorScore, long medianAutocompleteScore) = SyntaxScoring(lines);
        Console.WriteLine($"The total syntax error score is {syntaxErrorScore}.");
        Console.WriteLine($"The median autocomplete score is {medianAutocompleteScore}.");
    }
