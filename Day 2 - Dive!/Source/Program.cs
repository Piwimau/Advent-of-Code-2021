...
internal sealed partial class Program {
    ...
    /// <see cref="Program.Direction"/> of the <see cref="Command"/>.
    /// </param>
    ...
    private static void Main() {
        ...
        Console.WriteLine($"The simple score is {simpleScore}.");
        Console.WriteLine($"The complicated score is {complicatedScore}.");
    }
