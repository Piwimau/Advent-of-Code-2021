...
internal sealed class Program {
    ...
    private sealed class Grid {
        ...
        private Grid(int[][] energyLevels) {
            ArgumentNullException.ThrowIfNull(energyLevels, nameof(energyLevels));
        ...
        public static Grid Parse(string s) {
            ...
            int[][] energyLevels = [.. s.Split(Environment.NewLine)
    ...
    private static void Main() {
        ...
        Console.WriteLine($"After 100 steps, {flashes} total flashes occurred.");
        Console.WriteLine($"The first synchronization occurred after step {firstSyncStep}.");
    }
