...
internal sealed partial class Program {
    ...
    private static long ApplyPairInsertion(
        ...
        ArgumentNullException.ThrowIfNull(insertionRules, nameof(insertionRules));
    ...
    private static void Main() {
        ...
        Console.WriteLine($"After 10 steps, the difference is {difference10}.");
        Console.WriteLine($"After 40 steps, the difference is {difference40}.");
    }
