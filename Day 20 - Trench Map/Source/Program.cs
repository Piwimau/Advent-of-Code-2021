...
internal sealed class Program {
    ...
    private sealed class Image {
        ...
        private Image(ReadOnlySpan<Pixel> enhancementIndex, Pixel[][] pixels) {
            ...
            ArgumentOutOfRangeException.ThrowIfNotEqual(
                enhancementIndex.Length,
                RequiredEnhancementIndexLength,
                nameof(enhancementIndex)
            );
        ...
        public static Image Parse(string s) {
            ...
            Pixel[][] pixels = [.. parts[1].Split(Environment.NewLine)
                .Select(line => line.Select(ParsePixel).ToArray())
            ];
        ...
        public int Enhance(int steps) {
            ArgumentOutOfRangeException.ThrowIfNegative(steps, nameof(steps));
    ...
    private static void Main() {
        ...
        Console.WriteLine($"After 2 steps, {litPixelsAfterTwoSteps} pixels are lit.");
        Console.WriteLine($"After 50 steps, {litPixelsAfterFiftySteps} pixels are lit.");
    }
