...
namespace PassagePathing.Source;
...
internal sealed partial class Program {
    ...
    private sealed class Cave {
        ...
        /// <summary>Gets the <see cref="Program.Type"/> of this <see cref="Cave"/>.</summary>
        ...
        /// <remarks>
        /// The <paramref name="name"/> determines the cave's <see cref="Program.Type"/>.
        /// See the <see cref="ParseCaves(ReadOnlySpan{string})"/> method for more information.
        /// </remarks>
        /// <param name="name">
        /// Name of the <see cref="Cave"/> which determines its <see cref="Program.Type"/>.
        /// </param>
    ...
    private static void Main() {
        ...
        Console.WriteLine($"{pathsVisitingOnce} paths visit all small caves exactly once.");
        Console.WriteLine($"{pathsVisitingAtMostTwice} paths visit at most one small cave twice.");
    }
